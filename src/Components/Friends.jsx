...
function Friends({ referralLink, onClose }) {
    ...
    return (
      <div className="fixed w-full h-full bg-slate-950 z-50  top-0 left-0 flex flex-col items-center justify-center">
        <h2 className="text-white uppercase animate-scaleUp">Invite Friends and get 1000 $MTT Points</h2>
        <div className="relative">
          <button
            className='w-72 bg-yellow-500 my-6 rounded-full flex flex-row justify-around px-5 py-2 animate-scaleUp'
