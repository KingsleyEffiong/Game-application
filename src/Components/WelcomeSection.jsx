...
function WelcomeSection({ handleGetStarted }) {
    ...
    return (
      ...
      >
        <Logo/>
        <img className='w-24 fixed top-10 right-3 animate-spinSlow' src={mounttechCoin} alt="coin" />
        <h1 className='text-white uppercase px-3 md:text-2xl animate-scaleUp'>Let's get started for your reward🥰</h1>
        <div className='mx-4'>
          <input
            className='w-80 my-3 rounded-full px-4 py-2 bg-slate-300 text-sm placeholder:text-stone-950 focus:outline-none focus:ring focus:ring-yellow-400 border-none focus:ring-opacity-50 animate-scaleUp'
            type="text"
            value={input}
